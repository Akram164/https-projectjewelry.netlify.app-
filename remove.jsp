...
<html lang="en">
  <%
    String pageName = "Remove Student";
    ...
    <script>
        ...
        function removeStudent() {
            ...
            .then(result => {
                if (result.ok) {
                    // success
                    const msg = result.data && result.data.message ? result.data.message : "Student removed successfully.";
                    showMessage(msg, "success");
                } else {
                    // server returned an error status (like 400/500). show message if present
                    const errMsg = result.data && result.data.message ? result.data.message : ("Error removing student. Status: " + result.status);
            ...
            .catch(error => {
                ...
                showMessage("Error removing student. Please try again.", "danger");
  ...
  <body>
    ...
    <div class="main-content">
        ...
        <form onsubmit="event.preventDefault(); removeStudent();">
          <div class="form-row">
