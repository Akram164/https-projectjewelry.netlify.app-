...
<html lang="en">
  <%
    String pageName = "Register Student";
  ...
  <head>
    ...
    <script>
        ...
        function registerStudent() {
            ...
            const params = `name=${encodeURIComponent(name)}&email=${encodeURIComponent(email)}&phone=${encodeURIComponent(phone)}&course=${encodeURIComponent(course)}`;
            ...
            .then(result => {
                if (result.ok) {
                    // success
                    const msg = result.data && result.data.message ? result.data.message : "Student registered successfully.";
                    ...
                    const errMsg = result.data && result.data.message ? result.data.message : ("Error registering student. Status: " + result.status);
