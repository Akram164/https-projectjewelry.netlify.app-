...
<html lang="en">
  <%
    String pageName = "Update Student";
  ...
  <head>
    ...
    <script>
        ...
        function updateStudent() {
            ...
            const params = `id=${encodeURIComponent(id)}&name=${encodeURIComponent(name)}&email=${encodeURIComponent(email)}&phone=${encodeURIComponent(phone)}&course=${encodeURIComponent(course)}`;

            fetch("http://localhost/StudentManagementSystem/api/student?" + params,
                {
                    method: "PUT",
                    headers: {"Content-Type": "application/x-www-form-urlencoded"}
                }
            )
            // parse JSON even if status is not 200, then decide based on response.ok
            .then(response =>
            ...
            .then(result => {
                if (result.ok) {
                    // success
                    const msg = result.data && result.data.message ? result.data.message : "Student updated successfully.";
                    ...
                    // server returned an error status (like 400/500). show message if present
                    const errMsg = result.data && result.data.message ? result.data.message : ("Error updating student. Status: " + result.status);
  ...
  <body>
    ...
    <div class="main-content">
        ...
        <!-- Message Div (Bootstrap alert). Initially hidden with d-none -->
        ...
        <form onsubmit="event.preventDefault(); updateStudent();">
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="number" class="form-control" id="studentPhone" placeholder="Phone" required>
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="studentCourse">Course ID</label>
            <input type="number" class="form-control" id="studentCourse" placeholder="Course Id" required>
          </div>
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <h6 class="text-uppercase fw-bold mb-4">
                <i class="fas fa-gem me-3"></i><%= projectName %>
              </h6>
              <p>
